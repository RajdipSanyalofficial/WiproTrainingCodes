 ...
 *         * Calculate Simple Interest for a given Loan greater than 1lac
 */
...
public class SimpleInterestConditional {
    public static void main(String[] args) throws IOException {
        ...
        if(loan > 100000) {
            ...
            System.out.println("Not eligible for Loan. Please avail above 100000.");
